...
import {
  ...
  TimeCutIcon,
  TrainingGroupIcon,
} from '@/pages/Skills/SkillsImpactIcons'
import type { SkillImpactSummary } from '@/pages/Skills/skillImpact'
import { NPC_BASE_RELIST_DISCOUNT_PERCENT } from '@/lib/tradingFees'
import { formatTrainingDuration } from '@/pages/Skills/skillTraining'
