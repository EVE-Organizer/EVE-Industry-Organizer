...
import { applyChargeSelections, buildChargeGroups, type ChargeModuleGroup } from '@/pages/FitSkills/fitCharges'
...
import {
  ...
  resolveFit,
  skillRows,
} from '@/pages/FitSkills/fitSkills'
import { maxoutSkillsForFit, type MaxoutSkillEntry } from '@/pages/FitSkills/maxoutSkills'
import {
...
export interface FitAnalysis {
  ...
  ship: import('@/pages/FitSkills/types').FittingType
  items: import('@/pages/FitSkills/types').ResolvedFitItem[]
}
