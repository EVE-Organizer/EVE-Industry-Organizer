import { computeFitLoad, levelsFromSkillMap } from '@/pages/FitSkills/fitSkills'
import { clampLevel, omniEhp, skillPct, stackingProduct } from '@/pages/FitSkills/stacking'
import type {
  FitResists,
  FitShipStats,
  FitStatsContext,
