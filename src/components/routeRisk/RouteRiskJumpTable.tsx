...
import { gateKillBand, gateKillBandBadgeClass, explainGateIntel, zkillSystemUrl } from '@/lib/gateIntel'
import { jumpRowHighlightClass } from '@/lib/haulRiskDisplay'
  ...
  return (
    <div className="text-xs opacity-70 space-y-3">
      <div>
        ...
        <p>Security status plus ship and pod kills in the last 24 hours set each jump’s risk band.</p>
      </div>
      <div>
