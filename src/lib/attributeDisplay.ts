...
import { ATTRIBUTE_IMPLANT_BY_BONUS, resolveImplantIconTypeId } from '@/lib/skillImplants'
...
export function implantIconTypeId(
  attr: EveAttributeId,
  bonus: number,
  fittedTypeId?: number | null,
): number | null {
  return resolveImplantIconTypeId(attr, bonus, fittedTypeId)
}
